...
var consent = js_cookie__WEBPACK_IMPORTED_MODULE_1___default.a.get('cookie_consent');

if (consent == undefined) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(container).fadeIn();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(dismiss).on('click', function () {
    js_cookie__WEBPACK_IMPORTED_MODULE_1___default.a.set('cookie_consent', 'active', {
      expires: 7
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(container).fadeOut();
  });
}


new lazyload__WEBPACK_IMPORTED_MODULE_2___default.a();
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('input[type="checkbox"]').on('change', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent().toggleClass('checked');
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('input[type="radio"]').on('change', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('input[type="radio"]:not(:checked)').parent().removeClass('checked');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('input[type="radio"]:checked').parent().addClass('checked');
});
...
__webpack_require__(/*! /Users/lukeyouell/Repos/ddme/craft/src/js/app.js */"./src/js/app.js");
module.exports = __webpack_require__(/*! /Users/lukeyouell/Repos/ddme/craft/src/sass/app.scss */"./src/sass/app.scss");
